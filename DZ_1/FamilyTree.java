...
public class FamilyTree extends Main {
    public LinkedList<Person> familyList = Main.family;
    ...
    public static LinkedList releishonship(LinkedList<Person> familyList) throws IOException {
        ...
        for (int i = 0; i < familyList.size(); i++) {
            ...
            if (tempPerson.getStatus() == status.mother) {
                ...
                if (Objects.equals(answer, yes)) {
                    ...
                    for (int j = 0; j < familyList.size(); j++) {
                        ...
                        if ((Objects.equals(answer2, tempPerson2.getName())) && ((tempPerson2.getStatus() == status.son)
                                || tempPerson2.getStatus() == status.daughter)) {
                ...
                if (Objects.equals(answer, yes)) {
                    ...
                    for (int j = 0; j < familyList.size(); j++) {
                        ...
                        if ((Objects.equals(answer2, tempPerson2.getName()))
                                && ((tempPerson2.getStatus() == status.brother)
                                        || tempPerson2.getStatus() == status.sister)) {
                            String name = tempPerson.getName();
                            LinkedList list = new LinkedList<>();
                            list.add(tempPerson2);
                            System.out.println("Дети " + name + list);
            ...
            if ((tempPerson.getStatus() == status.wife) || (tempPerson.getStatus() == status.husband)) {
                ...
                for (int j = 0; j < familyList.size(); j++) {
                    Person tempPerson2 = familyList.get(j);
                    if ((Objects.equals(answer, tempPerson2.getName())) && ((tempPerson2.getStatus() == status.husband)
                            || tempPerson2.getStatus() == status.wife)) {
                        String name = tempPerson.getName();
                        LinkedList list = new LinkedList<>();
                        list.add(tempPerson2);
